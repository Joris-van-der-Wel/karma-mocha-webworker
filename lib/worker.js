...
rpc.methods({
        importScripts(scripts) {
                console.info('[karma-mocha-webworker Worker] Importing scripts into worker:', scripts);
        ...
        setupMocha(config) { // karma.config.mochaWebWorker
                console.info('[karma-mocha-webworker Worker] Initialize mocha.', config);
        ...
        runMocha(clientArguments) {
                console.info('[karma-mocha-webworker Worker] Run mocha');
                ...
                if (clientArguments) {
                        ...
                        if (grep) {
                                console.log('[karma-mocha-webworker Worker] mocha grep:', grep);
